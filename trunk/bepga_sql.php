<?php
$sql ="
  CREATE TABLE IF NOT EXISTS `estore_advertisements` (
...
CREATE TABLE IF NOT EXISTS `estore_albums` (
...
CREATE TABLE IF NOT EXISTS `estore_answerquestions` (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
  `name` varchar(256) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `estore_banners` (
  `id` int(50) unsigned NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `estore_categories` (
  `id` int(50) unsigned NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) unsigned NOT NULL DEFAULT '0',
  `tt` int(10) DEFAULT NULL,
  `parent_id` int(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `estore_catproducts` (
  `id` int(50) unsigned NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) unsigned NOT NULL DEFAULT '0',
  `parent_id` int(10) DEFAULT NULL,
  `lft` int(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `estore_comments` (
...
CREATE TABLE IF NOT EXISTS `estore_contacts` (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
  `name` varchar(50) NOT NULL,
  `email` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `estore_galleries` (
...
CREATE TABLE IF NOT EXISTS `estore_helps` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
  `title` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `estore_helpsd` (
...
CREATE TABLE IF NOT EXISTS `estore_infomationdetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `estore_infomations` (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `estore_manufacturers` (
  `id` int(50) unsigned NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) unsigned NOT NULL DEFAULT '0',
  `parent_id` int(10) DEFAULT NULL,
  `lft` int(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `estore_news` (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `estore_partners` (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `estore_settings` (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
  `name` varchar(256) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `estore_slideshows` (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
  `name` varchar(250) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `estore_users` (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `estore_videos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
  `name` varchar(250) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `estore_wards` (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
  `name` varchar(256) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `estore_weblinks` (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `estore_id` int(50) NOT NULL DEFAULT '0',
  `name` varchar(256) CHARACTER SET utf8 NOT NULL,
  `link` varchar(256) CHARACTER SET ucs2 NOT NULL,
