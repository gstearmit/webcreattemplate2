...
class WeblinksController extends AppController {
	...
	function index(){
		$this->account();
		$this->paginate=array('limit'=>'3','order'=>'Weblink.id DESC');
	...
	function add(){
		...
		if(!empty($this->data)){
			...
			$data['Weblink']['name']=ereg_replace("\n","<br/>",$data['Weblink']['name']);
			$data['Weblink']['link']=ereg_replace("\n","<br/>",$data['Weblink']['link']);
			$data['Weblink']['created']=ereg_replace("\n","<br/>",$data['Weblink']['created']);
			$data['Weblink']['modified']=ereg_replace("\n","<br/>",$data['Weblink']['modified']);
			$data['Weblink']['status']=ereg_replace("\n","<br/>",$data['Weblink']['status']);
