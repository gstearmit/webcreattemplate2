<?php echo $form->create(null, array( 'url' => DOMAINAD.'advertisements/add','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?> 
...
<div class="content-box"><!-- Start Content Box -->
    <div class="content-box-header">
        ...
        <ul class="content-box-tabs">
            <li><a href="#tab1" class="default-tab"><?php __('Add_advertisement')?></a></li> <!-- href must be unique and match the id of target div -->
        </ul>
        <div class="clear"></div>
        ...
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
                 ...
                 <tr>
                    ...
                    <td>
                     <input type="text" size="50" style="height:25px;"  name="userfile" readonly="true"> &nbsp;<a href="javascript:window.open('<?php echo DOMAINAD; ?>data.php','userfile','width=500,height=300');window.history.go(1)" ><input type="button" value="<?php __('Select_image')?>" class="button" /></a>
               ...
               <tr>
                    ...
                    <td>
                    <input type="radio" value="0" id="AdvertisementDisplay0" name="data[Advertisement][display]"> <?php __('Advertisement_in_the_left')?>
                    	&nbsp;&nbsp;&nbsp;<input type="radio" checked="checked" value="1" id="AdvertisementDisplay1" name="data[Advertisement][display]"> <?php __('Advertisement_in_the_right')?>
                    </td>
                </tr>
             <tr>
