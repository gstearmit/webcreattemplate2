 <?php //echo $form->create(null, array( 'url' => DOMAINAD.'news/edit','type' => 'post','name' => 'adminForm', 'inputDefaults' => array('label' => false,'div' => false)));?>
        ...
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
                ...
                <tr>
                    ...
                    <td>
                    <input type="radio" value="1" id="NewsHome1" <?php if($this->data['News']['homenews'] == 1 ) echo "checked='checked'"; ?> name="data[News][homenews]"> Có 
                    	&nbsp;&nbsp;&nbsp;<input type="radio" <?php if($this->data['News']['homenews'] == 0 ) echo "checked='checked'"; ?> value="0" id="NewsHome0" name="data[News][homenews]"> Không
                    </td>
                </tr>
                <tr>
                  	<td class="label">Tin mới:</td>
                    <td>
                    <input type="radio" value="1" id="NewsNews1" <?php if($this->data['News']['news'] == 1 ) echo "checked='checked'"; ?> name="data[News][news]"> Có 
                    	&nbsp;&nbsp;&nbsp;<input type="radio" <?php if($this->data['News']['news'] == 0 ) echo "checked='checked'"; ?> value="0" id="NewsNews0" name="data[News][news]"> Không
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" size="50" class="text-input medium-input datepicker" value="<?php echo $edit['News']['images'];?>" name="userfile" readonly="true"> &nbsp;<a href="javascript:window.open('<?php echo DOMAINAD; ?>upload_pic.php','userfile','width=500,height=300');window.history.go(1)" ><input type="button" value="Chọn ảnh" class="button" /></a>
                    </td>
                </tr>
                <tr>
