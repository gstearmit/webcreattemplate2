<br />
<?php echo $form->create(null, array( 'url' => DOMAINADESTORE.'bgmenu/add','type' => 'post','name' => 'adminForm', 'inputDefaults' => array('label' => false,'div' => false)));?>	   
<div id="khung">
	<div id="main">
		<div class="toolbar-list" id="toolbar">
			<ul>
                ...
                <li id="toolbar-unpublish">
                    <a href="<?php echo DOMAINADESTORE?>bgmenu" class="toolbar">
            ...
            <table class="input">
                ...
                <tr>
                    ...
                    <td>
                       ...
                       <span id="jPicker">
							<?php echo $this->Form->input('Bgmenu.color',array('class'=>'text-input medium-input datepicker','label'=>'','id' => 'Binded','value'=>'#ffffff','style'=>'color:#000;'));?>
                       </span>
                       </p>
                    </td>
                </tr>
