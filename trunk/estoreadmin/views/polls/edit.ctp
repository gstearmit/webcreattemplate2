...
<div id="khung">
	<div id="main">
		...
		<div class="pagetitle icon-48-category-add"><h2>Thăm dò ý kiến</h2></div>
		<div class="clr"></div>
	</div>
</div>
        ...
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
               	<tr>
                    ...
                    <td>
                    <?php echo $this->Form->input('Poll.name',array('class'=>'text-input medium-input datepicker','maxlength' => '250','onchange' => 'get_alias()','id' => 'idtitle'));?>
                     <?php echo $this->Form->input('Poll.id',array('class'=>'text-input medium-input datepicker','maxlength' => '250','onchange' => 'get_alias()','id' => 'idtitle'));?>
                    </td>
                </tr>
                <tr>
                  	<td class="label">Trang thái:</td>
                    <td>
                    <input type="radio" value="0" id="PollStatus0" name="data[Poll][status]"> Chưa Active 
                    	&nbsp;&nbsp;&nbsp;<input type="radio" checked="checked" value="1" id="PollStatus1" name="data[Poll][status]"> Đã Active
                    </td>
                </tr>
