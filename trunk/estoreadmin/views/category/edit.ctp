                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form action="<?php echo DOMAINADESTORE; ?>category/edit" enctype="multipart/form-data" name="adminForm" method="post" accept-charset="utf-8" class='form form-horizontal validate-form' style='margin-bottom: 0;'>
                       <input type="hidden" name="_method" value="POST" />
                       <input type="hidden" name="data[Category][id]" value="<?php echo $edit['Category']['id'];?>" />
                        <div class='form-group'>
                          <label class='control-label col-sm-3 col-sm-3' for='validation_name'><?php __('Category_name') ?> VN</label>
                          <div class='col-sm-4 controls'>
                            <input class='form-control' value="<?php echo $edit['Category']['name'];?>" data-rule-minlength='2' data-rule-required='true' id='validation_name' name="data[Category][name]" placeholder='<?php __('Category_name')?>' type='text'>
                          </div>
                        </div>  
                        <div class='form-group'>
                          <label class='control-label col-sm-3 col-sm-3' for='validation_name'><?php __('Category_name') ?> ENG</label>
                          <div class='col-sm-4 controls'>
                            <input class='form-control' value="<?php echo $edit['Category']['name_en'];?>" data-rule-minlength='2' data-rule-required='true' id='validation_name2' name="data[Category][name_en]" placeholder='<?php __('Category_name')?>' type='text'>
                          </div>
                        </div>  
                         <div class='form-group'>
                          <label class='control-label col-sm-3 col-sm-3' for='validation_name'><?php __('Static_linking')?></label>
                          <div class='col-sm-4 controls'>
                            <input class='form-control' value="<?php echo $edit['Category']['alias'];?>" data-rule-minlength='2' data-rule-required='true' id='validation_name1' name="data[Category][alias]" placeholder='<?php __('Static_linking')?>' type='text'>
                          </div>
                        </div> 
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                           <?php  //pr($Catproductlist);die();?>                  
                            ...
                            <select class='form-control' data-rule-required='true' id='validation_select' name="data[Category][parent_id]" >
                              ...
                              <option value="<?php  echo $key ?>"<?php if($key==$edit['Category']['id']){ echo "selected='selected'";}?>><?php  echo $value ?></option>
                           <?php }?>               
                            </select>                           
                          </div>
                        </div>
                        ...
                        <div class=' input-group col-sm-4 controls' >
                          <input class='form-control' value="<?php echo $edit['Category']['images'];?>" readonly='readonly' name='userfile' placeholder='<?php __('Image')?>' type='text'>
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                            <input class='form-control' value="<?php echo $edit['Category']['tt'];?>" data-rule-minlength='1' data-rule-required='true' id='validation_name2' name="data[Category][tt]" placeholder='<?php __('Brief_description')?>' type='text'>
                          </div>
                        </div>                         
                        <div class='form-group'>
                        ...
                        <div class='col-sm-4 controls'>
                          <label class='radio radio-inline'>
                            <input  name="data[Category][status]" type='radio' value='1' <?php if($edit['Category']['status']==1){ echo 'checked="checked"';}?>>
                            <?php __('Actived')?>
                          </label>
                          <label class='radio radio-inline'>
                            <input  name="data[Category][status]" type='radio' value='0' <?php if($edit['Category']['status']==0){ echo 'checked="checked"';}?> >
                             <?php __('Unactive')?>
                          </label>
                          </div>
                      </div>             
