<?php echo $form->create(null, array( 'url' => DOMAINADESTORE.'accounts/add','type' => 'post','name' => 'adminForm', 'inputDefaults' => array('label' => false,'div' => false)));?>
<br />  
<?php
...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
               	<tr>
               	    <?php echo $this->Form->input('User.estore_id',array('label' => '','type'=>'hidden','class'=>'text-input medium-input datepicker','value'=>$this->Session->read("id")));?>
                ...
                <tr>
                   	<td width="120" class="label"><?php __('Password')?>:</td>
                    <td>
                ...
                <tr>
                   	<td width="120" class="label"><?php __('Reset_password')?>:</td>
                    <td>
