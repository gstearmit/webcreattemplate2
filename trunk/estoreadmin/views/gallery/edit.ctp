<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-content">
        ...
        <div class="tab-content default-tab" id="tab2">
            ...
            <?php echo $form->create(null, array( 'url' => DOMAINADESTORE.'gallery/edit','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?>           
                ...
                <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                             ...
                             <select name="data[Gallery][album_id]">
                                     <option value="">Lựa chọn album ----</option>       
                                      <?php foreach ($Album as $key =>$value){?>                                                 
                                                 <option value="<?php echo $value['Album']['id']?>"><?php echo $value['Album']['name']?></option>      
                                      <?php }?>     
                                </select>    
                    ...
                    <p>
                        <label>Ảnh hiển thị</label>              
                          <input type="text" size="50" style="height:25px;"  value="<?php echo $edit['Gallery']['images']?>" name="userfile" readonly="true"> &nbsp;<font color="#FF0000"> <a href="javascript:window.open('<?php echo DOMAINADESTORE; ?>gallerys.php','userfile','width=500,height=300');window.history.go(1)" >[ upload ]</a> </font><font color="#FF0000">*</font>(jpg, jpeg, gif, png)
                    </p>
                    <p>
