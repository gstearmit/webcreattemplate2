                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form action="<?php echo DOMAINADESTORE; ?>slideshow/edit" enctype="multipart/form-data" name="adminForm" method="post" accept-charset="utf-8" class='form form-horizontal validate-form' style='margin-bottom: 0;'>
                       <input type="hidden" name="_method" value="POST" />
                        <input type="hidden" name="data[Slideshow][id]" value="<?php echo $edit['Slideshow']['id'];?>" />
                        <div class='form-group'>
                          <label class='control-label col-sm-3 col-sm-3' for='validation_name'><?php __('Image_name')?></label>
                          <div class='col-sm-4 controls'>
                            <input class='form-control' value="<?php echo $edit['Slideshow']['name'];?>"  data-rule-minlength='2' data-rule-required='true' id='validation_name' name="data[Slideshow][name]" placeholder='<?php __('Image_name')?>' type='text'>
                          </div>
                        </div>  
                        <div class='form-group'>
                        ...
                        <div class=' input-group col-sm-4 controls' >
                          <input class='form-control' value="<?php echo $edit['Slideshow']['images'];?>"  readonly='readonly' name='userfile' placeholder='<?php __('Image')?>' type='text'>
                        ...
                        <div class='col-sm-4 controls'>
                          <label class='radio radio-inline'>
                            <input  name="data[Slideshow][status]" type='radio' value='1' <?php if($edit['Slideshow']['status']==1){ echo 'checked="checked"';} ?>>
                            <?php __('Actived')?>
                          </label>
                          <label class='radio radio-inline'>
                            <input  name="data[Slideshow][status]" type='radio' value='0' <?php if($edit['Slideshow']['status']==0){ echo 'checked="checked"';} ?>>
                             <?php __('Unactive')?>
                          </label>
                          </div>
                      </div>                                      
