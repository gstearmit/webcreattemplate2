...
class FileUploader {
 ...
 // script để thực hiện quá trình upload
	...
	function __construct($fileTypesAllowed = 'jpg, jpeg, gif, png', $fileSizeMax = 5, $uploadDir = 'img/upload/') {
	...
	*/
	function getLink($i) {
		...
		$return .= "<tr><td colspan=\"2\"><a href=\"javascript:window.opener.document.adminForm.userfile.value='$link_bs';window.close();window.history.go(1);\">close</a></td> </tr></table>";
		return $return;
	}
}
?>
