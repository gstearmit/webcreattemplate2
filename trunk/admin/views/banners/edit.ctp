             ...
             <?php echo $form->create(null, array( 'url' => DOMAINAD.'banners/edit','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?>       
                ...
                <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                    ...
                    <p>
                        ...
                        <input type="text" size="50" style="height:25px;"  value="<?php echo $edit['Banner']['images']?>" name="userfile" readonly="true"> &nbsp;<font color="#FF0000"> <a href="javascript:window.open('<?php echo DOMAINAD; ?>gallery.php','userfile','width=500,height=300');window.history.go(1)" >[ upload ]</a> </font><font color="#FF0000">*</font>(jpg, jpeg, gif, png)
                    </p>
                   
                     <p>
                        <label>Trạng thái</label>
                        <?php echo $form->input('Banner.id',array('label' => '','type'=>'hidden'));?>
