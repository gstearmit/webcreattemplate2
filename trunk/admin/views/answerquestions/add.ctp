          ...
          <div id="content-table-inner">
            ...
            <div id="table-content">
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
				  ...
				  <tr >
                    <td>Nội dung </td>
                    <td><?php  echo $this->Form->input('content').$this->TvFck->create('News.content',array('toolbar'=>'extra','height'=>'400px','width'=>'900')); ?></td>
                  </tr>
                  <tr class="alternate-row">
                    <td>Danh mục</td>
                    <td> <?php echo $this->Form->input('category_id',array('type'=>'select','options'=>$list_cat,'empty'=>'Chọn danh mục','style'=>'width:150px;height:25px;','label'=>''));?></td>
                  </tr>
				   <tr>
                    <td>Ảnh đại diện</td>
                    <td>  
                   ...
                   <tr  class="alternate-row">
                    ...
                    <td> <?php echo $form->input('News.source',array( 'label' => '','style'=>'width:320px;height:25px;'));?></td>
                  </tr>
                   <tr>
                    <td>Trạng thái</td>
                    <td><?php echo $form->radio('News.status', array(0 => 'Chưa kích hoạt &nbsp;&nbsp;', 1 => '&nbsp;Đã kích hoạt'), array('value' => '1','legend'=>'')); ?> </td>
                  </tr>
                 <tr>
                    <td colspan="2">
