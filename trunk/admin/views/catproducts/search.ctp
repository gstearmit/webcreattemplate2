                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form action="<?php echo DOMAINAD ?>catproducts/search<?php echo $langs?>" enctype="multipart/form-data" name="image" method="post" accept-charset="utf-8" class='form form-horizontal validate-form' style='margin-bottom: 0;'>
                              ...
                              <tr>
                                ...
                                <?php if($value['Catproduct']['status']==0){?>
                                  <div class='text-right'>
                                    <a class='btn btn-inverse btn-xs' href='<?php echo DOMAINAD?>catproducts/active/<?php echo $value['Catproduct']['id'] ?><?php echo $langs?>'>
                                      <i class='icon-minus-sign'></i>
                                    </a>
                                    <a class='btn btn-warning btn-xs' href='<?php echo DOMAINAD?>catproducts/edit/<?php echo $value['Catproduct']['id'] ?><?php echo $langs?>'>
                                      <i class='icon-edit'></i>
                                    </a>
                                    <a class='btn btn-danger btn-xs' href="javascript:confirmDelete('<?php echo DOMAINAD?>catproducts/delete/<?php echo $value['Catproduct']['id'] ?><?php echo $langs?>')">
                                      <i class='icon-remove'></i>
                                    </a>
                                  </div>
                                  <?php }else {?>
                                  <div class='text-right'>
                                    <a class='btn btn-success btn-xs' href='<?php echo DOMAINAD?>catproducts/close/<?php echo $value['Catproduct']['id'] ?><?php echo $langs?>'>
                                      <i class=' icon-ok'></i>
                                    </a>
                                    <a class='btn btn-warning btn-xs' href='<?php echo DOMAINAD?>catproducts/edit/<?php echo $value['Catproduct']['id'] ?><?php echo $langs?>'>
                                      <i class='icon-edit'></i>
