                  ...
                  <div class='page-header'>                  	
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'><?php __('News_list')?></li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header ' style=" background:#f34541;">
                      <div class='title' style="color: #fff; bacground:#f34541;"><?php __('News_list')?>.</div>
                      <div class='actions'>
                        <a class="btn box-remove btn-xs btn-link" href="#"><i class='icon-remove'></i>
                        </a>
                            ...
                            <tbody>
                             <?php $i=1; foreach ($Newshop as $key =>$value){?>
                              <tr>
                                ...
                                <td>
                                <a href='<?php echo DOMAINAD?>newshops/view/<?php echo $value['Newshop']['id'] ?><?php echo  $langs ?>'>
