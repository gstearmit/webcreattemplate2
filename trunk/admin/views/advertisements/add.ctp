        ...
        <div class="tab-content default-tab" id="tab2">
            ...
            <?php echo $form->create(null, array( 'url' => DOMAINAD.'advertisements/add','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?>       
                ...
                <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                    <p>
                        <label>Tiêu đề</label>
                        <?php echo $form->input('Advertisement.name',array( 'label' => '','class'=>'text-input medium-input datepicker'));?>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <?php echo $form->input('Advertisement.link',array( 'label' => '','class'=>'text-input medium-input datepicker'));?>
                    </p>
                    <p>
                        <label>Trạng thái</label>
                        <?php echo $form->radio('Advertisement.status', array(0 => 'Chưa Active', 1 => 'Đã Active'), array('value' => '1','legend'=>'')); ?>
                    </p>
                    <p>
