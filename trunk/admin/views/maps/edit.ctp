...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-content">
        ...
        <div class="tab-content default-tab" id="tab2">
            ...
            <?php echo $form->create(null, array( 'url' => DOMAINAD.'maps/edit','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?>       
              ...
              <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                    ...
                    <p>
                        ...
                        <input type="text" size="80" style="height:25px;" name="userfile1"  value="<?php echo $edit['Map']['images']?>"> &nbsp;<font color="#FF0000"> <a href="javascript:window.open('<?php echo DOMAINAD; ?>upload_pic.php?stt=1','userfile1','width=500,height=300');window.history.go(1)" >[ upload ]</a> </font><font color="#FF0000">*</font>(jpg, jpeg, gif, png)
                    </p>
                     
                      <p>
                        <label>Trạng thái</label>
                         <?php echo $form->radio('Map.status', array(0 => 'Chưa Active', 1 => 'Đã Active'), array('value' => '1','legend'=>'')); ?>
                         <?php echo $form->input('Map.id',array( 'label' => ''));?>
                            </p>
                    <p>
