            ...
            <div id="table-content">
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                  <tr>
                    <td>Tên Danh mục</td>
                    <td>
                    <?php echo $form->input('Category.name',array( 'label' => '','style'=>'width:250px;height:25px;'));?>
                    </td>
                  </tr>
                   ...
                   <td >
                    <?php 
							echo $form->select('Category.parent_id', $categorylist, null,array('empty'=>'Chọn danh mục','style'=>'height:25px;width:150px;'));
						?>    
                    </td>
                  </tr>
