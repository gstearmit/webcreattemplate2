            ...
            <div id="table-content">
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                  <tr>
                    <td>Tên Danh mục</td>
                    <td>
                   <?php echo $form->input('Category.name',array('label'=>'','style'=>'width:400px;hieght:25px;'));?>
                   </td>
                  </tr>
                   ...
                   <td >
               <?php  echo $form->select('Category.parent_id', $list_cat,null,array('empty'=>'Danh mục cha (lớn nhất)')); ?>    
                    </td>
                  </tr>
                  <tr>
                    <td>Trạng thái</td>
