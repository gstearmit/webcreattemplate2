        ...
        <td><!--  start content-table-inner ...................................................................... START -->
          <div id="content-table-inner">
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                  ...
                  <tr class="alternate-row">
					...
					<?php if($value['Partner']['status']==0){?>  
                   	<a href="<?php echo DOMAINAD?>partners/edit/<?php echo $value['Partner']['id'] ?>" title="Sủa" class="icon-1 info-tooltip"></a>
                    <a href="<?php echo DOMAINAD?>partners/active/<?php echo $value['Partner']['id'] ?>" title="Kích hoạt" class="icon-5 info-tooltip"></a>
                    <a href="javascript:confirmDelete('<?php echo DOMAINAD?>partners/delete/<?php echo $value['Partner']['id'] ?>')" title="Xóa" class="icon-2 info-tooltip"></a>
					<?php } else {?>                  
                    <a href="<?php echo DOMAINAD?>partners/edit/<?php echo $value['Partner']['id'] ?>" title="Sủa" class="icon-1 info-tooltip"></a>
                    <a href="<?php echo DOMAINAD?>partners/close/<?php echo $value['Partner']['id'] ?>" title="Đóng" class="icon-4 info-tooltip"></a>
                    <a href="javascript:confirmDelete('<?php echo DOMAINAD?>partners/delete/<?php echo $value['Partner']['id'] ?>')" title="Xóa" class="icon-2 info-tooltip"></a><?php }?>
                    </td>
                  </tr>
                <?php }?>
                </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="paging-table">
              <tr>
			  	<td><div><a href="<?php echo DOMAINAD?>partners/add" title="Thêm Mới"<img src="<?php echo DOMAINAD?>images/folder-new.png" /><b>Thêm mới đối tác</b></a></div>
                </td>
                </tr>
                <tr height="30"></tr>
                <tr>
