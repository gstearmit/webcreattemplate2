...
class FileUploader {
 ...
 // script để thực hiện quá trình upload
	...
	function __construct($fileTypesAllowed = 'flv,mp4', $fileSizeMax = 150, $uploadDir = 'video/upload/') {
	...
	*/
	function getLink($i) {
		...
		$return .= "<tr><td colspan=\"2\"><a href=\"javascript:window.opener.document.image.video.value='$link_bs';window.close();window.history.go(1);\">close</a></td> </tr></table>";
		return $return;
	}
}
?>
