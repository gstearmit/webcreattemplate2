e<div class="content-box"><!-- Start Content Box -->
            ...
            <?php echo $form->create(null, array( 'url' => DOMAINAD.'gallery/edit','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?>           
                ...
                <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                    ...
                    <p>
                        ...
                        <?php echo $form->radio('Gallery.display', array(1 => 'Trái', 2 => 'Phải'), array('value' => '1','legend'=>'')); ?>
                    </p>
                    <p>
                        <label>Ảnh hiển thị</label>              
                          <input type="text" size="50" style="height:25px;"  value="<?php echo $edit['Gallery']['images']?>" name="userfile" readonly="true"> &nbsp;<font color="#FF0000"> <a href="javascript:window.open('<?php echo DOMAINAD; ?>gallery.php','userfile','width=500,height=300');window.history.go(1)" >[ upload ]</a> </font><font color="#FF0000">*</font>(jpg, jpeg, gif, png)
                    </p>
                    <p>
