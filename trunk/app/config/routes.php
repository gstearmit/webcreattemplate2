...
// 		));
   ...
   // Router::connect('/e-commerce', array('controller' => 'home', 'action' => 'ecommerce'));
    Router::connect('/e-commerce', array('controller' => 'home', 'action' => 'index'));
    ...
    //Router::connect('/finish', array('controller' => 'comment', 'action' => 'finish'));
    Router::connect('/finishmoreuse', array('controller' => 'moreuse', 'action' => 'finish'));
