...
<script>
 ...
 <br /><br /><br />
<form method="post" id="check_form" action="<?php echo DOMAIN; ?>bepga/sendcontacts" style=";">
 ...
 <form method="post" id="check_form" action="<?php echo DOMAIN; ?>bepga/sendcontacts">
    <table class="guimail" align="left" width="600px">
