    ...
    <div id="conten_main_right-jcarousellite">
	   ...
	   <ul>
          ...
          <li style="margin-bottom:10px; padding-bottom:10px;">
             ...
             <div style=" overflow:hidden; width:156px; height:107px; background-image:url(<?php echo DOMAINAD?>/timthumb.php?src=<?php echo $listproduct['Product']['images'];?>&amp;h=107&amp;w=156&amp;zc=1); background-position:center center; background-repeat:no-repeat; background-color:#FFF; margin:auto;" class="img">             
