	...
	<div class="right" style="border-radius: 6px 6px 6px 6px;">
		<div id="classifieds">
			...
			<div style="padding: 10px;">
				<table width="750px" border="0">
                    ...
                    <?php $i=1; foreach($categoryshop as $categoryshop){?>
                    <tr>
						<td width="52" style="width:25px; text-align:center; padding:0px;"><?php echo $i;?></td>
						<td width="238" style="width:200px; text-align:center;"><?php echo $categoryshop['Categoryshop']['name'];?></td>
                        <td width="238" style="width:100px; text-align:center;"><?php echo $categoryshop['Categoryshop']['order'];?></td>
						<td width="119" style="width:50px; text-align:center; padding:0px;">
                           <a href="<?php echo DOMAIN?>sua-danh-muc/<?php echo $categoryshop['Categoryshop']['id'] ?>"><img src="<?php ?>images/pencil.png"/>Sửa</a> <br /> <a href="javascript:confirmDelete('<?php echo DOMAIN?>categoryshops/delete/<?php echo $categoryshop['Categoryshop']['id'] ?>')"><img src="<?php ?>images/icon_delete.gif"/>Xóa</a>
                        </td>
					</tr>
                    <?php $i++; }?>
				</table>
		...
		<div id="j_idt187" class="ui-dialog ui-widget ui-corner-all ui-helper-hidden ui-draggable ui-resizable" style="width: 510px; height: auto; display: none; top: 66px; right: 213px;z-index: 1024; border:1px solid #AED0EA; -moz-border-radius: 4px; -webkit-border-radius: 4px; border-radius: 4px;">
			<div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix">
				<div style="width:370px; float:left"><span class="ui-dialog-title">Thêm mới danh mục trên VINAMAX</span></div>
				...
				<span id="catTreeArea">
						...
						<div style="height: 240px;width:100%; float: left;">
							<div class="ui-dialog-content ui-widget-content" style="height: auto;">
                                <form enctype="multipart/form-data" action="<?php echo DOMAIN;?>categoryshops/add" method="post" name="updateCatForm" id="updateCatForm">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button type="submit" onclick="PrimeFaces.ab({formId:'updateCatForm',source:'updateCatForm:j_idt227',process:'@all',update:'mainForm updateCatForm'});return false;" name=`"updateCatForm:j_idt227" id="updateCatForm:j_idt227" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false"><span class="ui-button-text">Thêm mới</span></button>
                                                        &nbsp;
                                                        <div style="background: none repeat scroll 0 0 #E2E2E2; border: 1px solid #AED0EA; border-radius: 6px 6px 6px 6px; color: #4C4C4C; padding-bottom: 3px; padding-top: 3px; text-align: center; float: right;margin-right: 200px; width: 60px;"><a href='javascript:setVisibility("j_idt187")'> Đóng </a></div>
                                                    </td>
                                                </tr>
