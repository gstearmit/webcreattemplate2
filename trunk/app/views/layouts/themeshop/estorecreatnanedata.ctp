...
<script>
    ...
    <div id="wrapper">  
		<div id="header">
         <?php echo $this->element('/themeshop/estorecreatnanedata/header');?> 
         </div>
         <div id="menu">
        	<?php echo $this->element('/themeshop/estorecreatnanedata/menu');?>
         </div>
         <div id="bgiohang">
            <div id="giohang">
                <div class="solo">
         ...
         <div id="content">
               <div id="menu-left">
               <?php echo $this->element('/themeshop/estorecreatnanedata/left');?>
               </div>
                <?php echo $this->element('/themeshop/estorecreatnanedata/slide');?>
   		       <div id="main">
               ...
               <div id="menu-right">
               <?php echo $this->element('/themeshop/estorecreatnanedata/right'); ?>
               </div>
        ...
        <div id="footer">
                <?php echo $this->element('/themeshop/estorecreatnanedata/footer');?>                
            </div><!--end footer--> 
    </div><!--end wrapper-->
</body>
</html>