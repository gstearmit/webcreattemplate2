...
<?php echo $this->element('themeshop/estoredaquy/plugin/plugin-seo');?>
...
<body>
<?php echo $this->element('themeshop/estoredaquy/plugin/plugin-adv-left-right');?>
    <div id="wrapper-background">
        <div id="wrapper">
            	   <div id="header">
                       <?php echo $this->element('themeshop/estoredaquy/plugin/plugin-header');?>
                   </div> <!---id="header"-->
				   
                        <?php echo $this->element('themeshop/estoredaquy/menu');?>
                        ...
                        <div id="boder-content">
                                    ...
                                    <div id="content">
                                          ...
                                          <div id="main">
                                                ...
                                                <div class="center-main">
                                                   ...
                                                   <?php echo $this->element('themeshop/estoredaquy/slide');?>
                                       ...
                                       <?php echo $this->element('themeshop/estoredaquy/sidebar-left');?> 
                          ...
                          <div id="footer" style="background:url(../images/bg-footer.png)">
                              ...
                              foreach ( $mapssettings as $settings ) {?>
								<p><?php echo $settings['Estore_settings']['content'];?></p>
                              <?php }  ?>
