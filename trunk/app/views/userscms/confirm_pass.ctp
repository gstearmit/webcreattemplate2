       ...
       <?php echo $form->create(null, array( 'url' => DOMAIN.'userscms/change_pass','type' => 'post')); ?>	
        ...
        <table>
            ...
            <tr>
                ...
                <?php
                 echo $email;
                 echo $this->Form->input('Userscms.email',array('label'=>'','type'=>'hidden','value'=>$email,'readonly'=>'true','style'=>'width:250px;height:25px;'));?>
                </td>
            </tr>
            <tr height="25"></tr>
            <tr>
                ...
                <?php 
                if($password_old==''){
                echo $this->Form->input('Userscms.password_old',array('label'=>'','type'=>'hidden','value'=>$password_old,'style'=>'width:250px;height:25px;'));	
                }
                if($password_old!=''){
                echo '*********';
                echo $this->Form->input('Userscms.password_old',array('label'=>'','type'=>'hidden','value'=>$password_old,'style'=>'width:250px;height:25px;'));
            ...
            <tr>
                ...
                <?php
                if($password=='') {
                    echo $this->Form->input('Userscms.password_new',array('label'=>'','type'=>'hidden','value'=>$password,'style'=>'width:250px;height:25px;'));
                }
                if($password!=''){
                echo '*********';
                echo $this->Form->input('Userscms.password_new',array('label'=>'','type'=>'hidden','value'=>$password,'style'=>'width:250px;height:25px;'));
            ...
            <td>
                 <?php echo $this->Form->input('Userscms.id',array('label'=>'','value'=>$id,'type'=>'hidden'));?>
            </td></tr>
            <tr>
