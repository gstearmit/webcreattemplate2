...
$(document).ready(function(){
	$("#email-forgot-Password").change(function(){
		...
		$.ajax({
				type: "GET", 
				url: "<?php echo DOMAIN;?>"+'userscms/ck_email_forgot_pass/',
	...
	$("#security").change(function(){
		...
		$.ajax({
				type: "GET", 
				url: "<?php echo DOMAIN;?>"+'userscms/security_forgot_pass/',
...
<form class="cmxform" id="signupForm" method="POST" action="<?php echo DOMAIN?>userscms/processor_forgot_password">
		...
		<div id="login-new-main">
			...
			<div id="login-new-security"><label>Mã bảo vệ</label><img alt="" src="<?php echo DOMAIN?>userscms/create_image" /></div>
