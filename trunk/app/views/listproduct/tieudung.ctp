 ...
 <div id="main-content">
	 ...
	 <div class="menu-top" style="background: url(<?php echo DOMAIN?>/images/bgtieudung.png) no-repeat;">
	 	<ul>
	 		...
	 		<li class="li-menu" style="margin-left:62px;"><a style="color:#30b44c;" href="<?php echo DOMAIN?>tieu-dung">TIÊU DÙNG</a></li>
	 ...
	 <ul>
	 	...
	 	<li ><a href="<?php echo DOMAIN?>tieu-dung" class="a-cuoi">Tiêu dùng</a></li>
	 </ul>
