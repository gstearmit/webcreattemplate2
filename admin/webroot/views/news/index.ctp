              ...
              <form id="mainform" action="">
                <table border="1" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                  ...
                  <tr class="alternate-row">
                    ...
                    <a href="<?php echo DOMAINAD?>news/active/<?php echo $value['News']['id'] ?>" title="Kích hoạt" class="icon-5 info-tooltip"><input type="button" value="Xóa" /></a>
                    <a href="javascript:confirmDelete('<?php echo DOMAINAD?>news/delete/<?php echo $value['News']['id'] ?>')" title="Xóa" class="icon-2 info-tooltip"><input type="button" value="Active" /></a>
					<?php } else {?>                  
                    <a href="<?php echo DOMAINAD?>news/edit/<?php echo $value['News']['id'] ?>" title="Sủa" class="icon-1 info-tooltip"><input type="button" value="Sửa" /></a>
                    <a href="<?php echo DOMAINAD?>news/close/<?php echo $value['News']['id'] ?>" title="Đóng" class="icon-4 info-tooltip"><input type="button" value="Xóa" /></a>
                    <a href="javascript:confirmDelete('<?php echo DOMAINAD?>news/delete/<?php echo $value['News']['id'] ?>')" title="Xóa" class="icon-2 info-tooltip"><input type="button" value=" Ngắt Active" /></a><?php }?>
                    </td>
                  </tr>
                <?php }?>
                </table>
