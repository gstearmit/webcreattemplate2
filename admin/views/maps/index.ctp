...
if (confirm("Bạn có muốn xóa danh mục này không!"))
{
 ...
 <?php echo $form->create(null, array( 'url' => DOMAINAD.'maps/search','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?> 
     ...
     <?php echo $form->end(); ?>
     <p><a href="<?php echo DOMAINAD;?>maps/add"> <input type="submit" name="" value="Thêm mới" class="button" /></a></p>
            ...
            <table>
                ...
                <tbody>
                   ...
                   foreach ($Map as $key =>$value){?>
                    <tr>
                        <td><input type="checkbox" name="<?php echo $value['Map']['id'] ?>"/></td>
                        <td><?php $j=$key+1; echo $j;?></td>
                        <td> <?php echo $value['Map']['name'];?></td>
                         <th>  <td><img src="<?php echo DOMAINAD?>/timthumb.php?src=<?php echo $value['Map']['images'];?>&amp;h=70&amp;w=100&amp;zc=1" alt="thumbnail" /></td>
                       </th>
