                  ...
                  <div class='page-header'>
                    ...
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'><?php __('List_images')?></li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header ' style=" background:#f34541;">
                      <div class='title' style="color: #fff; bacground:#f34541;"><?php __('List_images')?>.</div>
                      <div class='actions'>
                    ...
                    <div class='box-content box-no-padding'>
                      <div class='responsive-table'>
                        ...
                        <form action="<?php echo DOMAINAD;?>gallery/processing<?php echo $langs ?>" name="form1" method="post">
                          <table class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                             <?php $i=1; foreach ($Gallery as $key =>$value){?>
                              <tr>
                              	<td><input style="width:20px; height:20px;" type="checkbox" name="<?php echo $value['Gallery']['id'] ?>" /></td>
                                ...
                                <?php if($value['Gallery']['status']==0){?>
                                  <div class='text-right'>
                                    <a class='btn btn-inverse btn-xs' href='<?php echo DOMAINAD?>gallery/active/<?php echo $value['Gallery']['id'] ?><?php echo $langs ?>'>
                                      <i class='icon-minus-sign'></i>
                                    </a>
                                    <a class='btn btn-warning btn-xs' href='<?php echo DOMAINAD?>gallery/edit/<?php echo $value['Gallery']['id'] ?><?php echo $langs ?>'>
                                      <i class='icon-edit'></i>
                                    </a>
                                    <a class='btn btn-danger btn-xs' href="javascript:confirmDelete('<?php echo DOMAINAD?>gallery/delete/<?php echo $value['Gallery']['id'] ?><?php echo $langs ?>')">
                                      <i class='icon-remove'></i>
                                    </a>
                                  </div>
                                  <?php }else {?>
                                  <div class='text-right'>
                                    <a class='btn btn-success btn-xs' href='<?php echo DOMAINAD?>gallery/close/<?php echo $value['Gallery']['id'] ?><?php echo $langs ?>'>
                                      <i class=' icon-ok'></i>
                                    </a>
                                    <a class='btn btn-warning btn-xs' href='<?php echo DOMAINAD?>gallery/edit/<?php echo $value['Gallery']['id'] ?><?php echo $langs ?>'>
                                      <i class='icon-edit'></i>
