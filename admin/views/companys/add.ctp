...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-content">
        ...
        <div class="tab-content default-tab" id="tab2">
             ...
             <?php echo $form->create(null, array( 'url' => DOMAINAD.'companys/add','type' => 'post','enctype'=>'multipart/form-data','name'=>'image')); ?>       
                ...
                <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                    ...
                    <p>
                     ...
                     <p>
                        <label>Website</label>
                           <?php echo $form->input('website',array( 'label' => '','class'=>'text-input medium-input datepicker'));?>
                    </p>
