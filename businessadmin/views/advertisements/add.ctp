        ...
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
                 ...
                 <tr>
                    ...
                    <td>
                     <input type="text" size="50" style="height:25px;"  name="userfile" readonly="true"> &nbsp;<a href="javascript:window.open('<?php echo DOMAINAD; ?>data.php','userfile','width=500,height=300');window.history.go(1)" ><input type="button" value="Chọn ảnh" class="button" /></a>
               ...
               <tr>
                    ...
                    <td>
                    <input type="radio" value="0" id="AdvertisementDisplay0" name="data[Advertisement][display]"> Quảng cáo trái
                    	&nbsp;&nbsp;&nbsp;<input type="radio" checked="checked" value="1" id="AdvertisementDisplay1" name="data[Advertisement][display]"> Quảng cáo phải
                    </td>
                </tr>
             <tr>
