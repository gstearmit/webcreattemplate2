<?php echo $form->create(null, array( 'url' => DOMAINAD.'Weblink/edit','type' => 'post','name' => 'adminForm', 'inputDefaults' => array('label' => false,'div' => false)));?>
<br />  
<?php
		...
		<div class="toolbar-list" id="toolbar">
			<ul>
                ...
                <li id="toolbar-unpublish">
                    <a href="<?php echo DOMAINAD?>Slideshows" class="toolbar">
        ...
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
             ...
             <tr>
                    ...
                    <td>
                                        <?php echo $this->Form->input('Weblink.id',array('type'=>'hidden'));?>
