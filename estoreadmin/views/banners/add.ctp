                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form action="<?php echo DOMAINADESTORE; ?>banners/add" enctype="multipart/form-data" name="image" method="post" accept-charset="utf-8" class='form form-horizontal validate-form' style='margin-bottom: 0;'>
                       <input type="hidden" name="_method" value="POST" />
                        <div class='form-group'>
                          <label class='control-label col-sm-3 col-sm-3' for='validation_name'><?php __('Company_name')?></label>
                          <div class='col-sm-4 controls'>
                            <input class='form-control' data-rule-minlength='2' data-rule-required='true' id='validation_name' name="data[Banner][name]" placeholder='<?php __('Company_name')?>' type='text'>
                          </div>
                        </div>  
                        <div class='form-group'>
                        ...
                        <div class=' input-group col-sm-4 controls' >
                          <input class='form-control' readonly='readonly' name="userfile" placeholder='<?php __('Image_banner')?>' type='text'>
                        ...
                        <div class='col-sm-4 controls'>
                          <label class='radio radio-inline'>
                            <input  name="data[Banner][status]" type='radio' value='1' checked="checked">
                            <?php __('Actived')?>
                          </label>
                          <label class='radio radio-inline'>
                            <input  name="data[Banner][status]" type='radio' value='0' >
                             <?php __('Unactive')?>
                          </label>
                          </div>
                      </div>                                      
