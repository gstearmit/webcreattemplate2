...
?>
<?php echo $form->create(null, array( 'url' => DOMAINADESTORE.'catproducts/add','type' => 'post','name' => 'adminForm', 'inputDefaults' => array('label' => false,'div' => false)));?>	   
<div id="khung">
	<div id="main">
...
<div class="content-box">
    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">  
            <table class="input">
               	<tr>
               	    <?php echo $this->Form->input('Catproduct.estore_id',array('label' => '','type'=>'hidden','class'=>'text-input medium-input datepicker','value'=>$this->Session->read("id")));?>
                ...
                <tr>
                    ...
                    <td>
                    <?php  echo $form->select('Catproduct.parent_id', $Catproductlist, null,array('empty'=>$select,'class'=>'small-input')); ?>
                    </td>
                </tr>
               <tr>
