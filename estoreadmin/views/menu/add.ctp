<?php echo $form->create(null, array( 'url' => DOMAINADESTORE.'menu/add','type' => 'post','name' => 'adminForm', 'inputDefaults' => array('label' => false,'div' => false)));?>	   
<div id="khung">
	<div id="main">
            ...
            <table class="input">
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td>
                    <?php echo $this->Form->input('Menu.order',array('class'=>'text-input medium-input datepicker','maxlength' => '10','style' => 'width:100px !important','value' => '0'));?>
					</td>
                </tr>
                <tr class="display_background">
                  	<td class="label">Trạng thái</td>
                    <td>
                    <?php echo $form->radio('Menu.status', array(0 => 'Chưa Active', 1 => 'Đã Active'), array('value' => '1','legend'=>'')); ?>  
					</td>
                </tr>
                <tr>
