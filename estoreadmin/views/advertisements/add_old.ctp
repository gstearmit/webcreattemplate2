        ...
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
                ...
                <tr>
                 ...
                 <tr>
                  	<td class="label"><?php __('Image_name')?>:</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                    <input type="radio" value="0" name="data[Advertisement][display]" id="AdvertisementDisplay0" /> <?php __('Advertisement_running_in_the_left')?><br />
                    <input type="radio" value="1" id="AdvertisementDisplay1" name="data[Advertisement][display]"/> <?php __('Advertisement_running_in_the_right')?><br />
                    <input type="radio" value="2" id="AdvertisementDisplay2" name="data[Advertisement][display]"/> <?php __('Advertisement_in_the_left')?><br />
                    <input type="radio" value="3" id="AdvertisementDisplay3" name="data[Advertisement][display]"/> <?php __('Advertisement_in_the_right')?><br />
                    </td>
                </tr>
             <tr>
