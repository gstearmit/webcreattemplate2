                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form action="<?php echo DOMAINADESTORE; ?>videos/edit" enctype="multipart/form-data" name="adminForm" method="post" accept-charset="utf-8" class='form form-horizontal validate-form' style='margin-bottom: 0;'>
                       ...
                       <input type="hidden" name="data[Video][id]" value="<?php echo $edit['Video']['id'];?>" />
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                            <input class='form-control' value="<?php echo $edit['Video']['name'];?>" data-rule-minlength='2' data-rule-required='true' id='validation_name' name="data[Video][name]" placeholder='<?php __('Title')?>' type='text'>
                          </div>
                        </div>  
                         <div class='form-group'>
                          <label class='control-label col-sm-3 col-sm-3' for='validation_name'><?php __('LinkUrl Youtube.com')?></label>
                          <div class='col-sm-4 controls'>
                            <input class='form-control' value="<?php echo $edit['Video']['LinkUrl'];?>" data-rule-minlength='2' data-rule-required='true' id='validation_name1' name="data[Video][LinkUrl]" placeholder='<?php __('LinkUrl Youtube.com')?>' type='text'>
                          </div>
                        </div> 
                         <div class='form-group'>
                        ...
                        <div class='col-sm-4 controls'>
                          <label class='radio radio-inline'>
                            <input  name="data[Video][left]" type='radio' value='0' <?php if($edit['Video']['left']==0){echo 'checked="checked"';}?>>
                            <?php __('Left')?>
                          </label>
                          <label class='radio radio-inline'>
                            <input  name="data[Video][left]" type='radio' value='1' <?php if($edit['Video']['left']==1){echo 'checked="checked"';}?>>
                             <?php __('Right')?>
                          </label>
                          </div>
                      </div>            
