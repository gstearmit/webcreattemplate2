                        ...
                        <div class="san-pham-chi-tiet-trai floatleft">
                            ...
                            <div class="bg-center-ha-chi-tiet" id="vlightbox">
                              <a href="<?php echo DOMAIN;?><?php echo $views['Productshop']['images']; ?>" class="vlightbox" rel="colorbox">
                                  <img style="width:200px;border-width:0px;" src="<?php echo DOMAIN;?><?php echo $views['Productshop']['images']; ?>" alt="<?php echo $views['Productshop']['title']?>" id="ctl08_imgChitiet">  
                               </a>
                             </div>
               ...
               <?php 
				...
				<li>
					<table class="img-124">
						<tr valign="middle">
							<td>
								<a href="<?php echo DOMAIN.$shopname;?>/chi_thiet_san_pham/<?php echo $productshops['Productshop']['id'];?>"><img alt="" class="" src="<?php echo DOMAIN;?><?php echo $productshops['Productshop']['images'];?>" /></a>
							</td>
						</tr>
					</table>
					<h4><a href="<?php echo DOMAIN.$shopname?>/chi_thiet_san_pham/<?php echo $productshops['Productshop']['id'];?>"><?php echo $productshops['Productshop']['title'];?></a></h4>
