            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="col-sm-1 col-md-1">
                    <!--  <button type="button" class="btn btn-danger" onclick="$('#removemodal').modal('show')"> <span class="glyphicon glyphicon-remove"></span> Remove </button> -->
                     <a href="javascript:confirmDelete('<?php echo DOMAIN;?><?php echo $shopname ;?>/deleteshopingcart/<?php echo $key;?>')"  class="btn btn-danger" > <span class="glyphicon glyphicon-remove"></span> Remove </a>
                </td>
