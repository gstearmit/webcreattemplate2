...
function reload()
{
	...
	jQuery.ajax({
		type: "GET", 
		url: "<?php echo DOMAIN;?>"+'registerstore/create_image1/'+random1,
		data: null,
		success: function(msg){	
		jQuery('#abc').find('img').remove().end();
		 jQuery('#abc').append('<img alt="" id="captcha" src="<?php echo DOMAIN?>registerstore/create_image1/'+random1+'" />');				
		}
	});	
}
            ...
            <table width="400" align="center;" style="margin:auto;">
                ...
                <tr>
                    ...
                    <td align="left" width="100">
                        <a id="abc">
                               <img alt="" id="captcha" src="<?php echo DOMAIN?>registerstore/create_image" /></a1>&nbsp;&nbsp;<a href="javascript: reload()"><img src="<?php echo DOMAIN?>images/change-image.gif"/>
                             </a>
                    </td>
                </tr>
                -->
