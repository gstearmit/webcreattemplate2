...
<div id="main-center">           
    ...
    <div id="sanphams"  style="min-height: 460px !important;">
    	<div class="top">Thế giới tủ bếp <p align="right" class="abc"><a style="line-height: 30px;padding-right: 15px;" href="<?php echo DOMAIN;?>bepga/all/106">Xem tất cả &nbsp;&nbsp;<img src="<?php echo DOMAIN;?>images/main_li.jpg" /></a></p></div>
    ...
    <div id="sanphams"  style="min-height: 435px !important;">
    	<div class="top">Bếp dự án nhà hàng - khách sạn<p align="right" class="abc"><a style="line-height: 30px;padding-right: 15px;" href="<?php echo DOMAIN;?>bepga/all/107">Xem tất cả &nbsp;&nbsp;<img src="<?php echo DOMAIN;?>images/main_li.jpg" /></a></p></div>
        <div style="min-height: 460px;">
    ...
    <div id="sanphams"  style="min-height: 435px !important;">
    	<div class="top">Sản phẩm trung & cao cấp<p align="right" class="abc"><a style="line-height: 30px;padding-right: 15px;" href="<?php echo DOMAIN;?>all-vip">Xem tất cả &nbsp;&nbsp;<img src="<?php echo DOMAIN;?>images/main_li.jpg" /></a></p></div>
       <div style="min-height: 460px;">
     ...
     <div id="sanphams"  style="min-height: 435px !important;">
    	<div class="top">Sản phẩm khuyến mại<p align="right" class="abc"><a style="line-height: 30px;padding-right: 15px;" href="<?php echo DOMAIN;?>bepga/khuyenmaiproduct">Xem tất cả &nbsp;&nbsp;<img src="<?php echo DOMAIN;?>images/main_li.jpg" /></a></p></div>
        <div style="min-height: 460px;">
