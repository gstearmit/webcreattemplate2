...
<ul>
	 ...
	 foreach($sanphammoi as $listproduct) // pr($listproduct);die; // giong mang $tranhdaquy
	 {
     	 ...
     	 $a[$j++] = $listproduct; ?>
		                       <?php //pr($a[0]); die; ?>
		                          <?php  //pr($listproduct['Estore_products']['id']);die;?>
			 <p>
				  <li>
					<h1>
					  <!-- ảnh của san phẩm-->
					...
					<h2>
					  <a style="color:#5a5152;" href="<?php echo DOMAIN.$shopname;?>/viewproduct/<?php echo $listproduct['Estore_products']['id'];?>" >
					      <?php echo $listproduct['Estore_products']['title']; // tiêu dề sản phẩm   ?>
					  </a>
					</h2>
					
				     <!-- class="div": hiển thị hình xem tiếp -->
					<div class="div" style="text-align:center;"><a href="<?php echo DOMAIN.$shopname;?>/viewproduct/<?php echo $listproduct['Estore_products']['id'];?>"><img src="<?php echo DOMAIN;?>daquybusniss/images/detail1.png" style="margin-top:10px;"/></a></h2>
					</div>
				  </li>
			  </p>
	       <?php $i++ ?>
