                    ...
                    <li class="seacrch_li">
                     <?php  if($productview['Estore_products']['images']!='') {?>
                        <a href="<?php echo DOMAIN.$shopname;?>/viewproduct/<?php echo $productview['Estore_products']['id']?>">   <img src="<?php echo DOMAINADBUSINISS.$productview['Estore_products']['images'];?>"  alt="<?php echo $productview['Estore_products']['title']?>"/> </a>
                         ...
                         <?php }?> 
                    <h1 class="style_h1"> <a href="<?php echo DOMAIN.$shopname;?>/viewproduct/<?php echo $productview['Estore_products']['id']?>">
                     <?php echo strip_tags($this->Text->truncate( $productview['Estore_products']['title'],20,array('ending' => '...','exact' => false)));?></a></h1>
                    <h4 style="font-weight:bold; color:#cacaca;"><span style="float:left"> Giá: </span><span style="color:#FF5E24; float:left;"><?php echo $productview['Estore_products']['price'];?></span></h4> 
                    </li>
            <?php endforeach; ?> 
            </ul>
