		...
		<div id="classifieds">
			...
			<div style="padding: 10px;">
                <div style="padding-bottom:10px;">
                 ...
                 <?php echo $form->create(null, array( 'url' => DOMAIN.'newsshop/addcategory','type' => 'post','enctype'=>'multipart/form-data','id'=>'check_form','name'=>'image')); ?>    
                    <table>
                       <tr>
                        ...
                        <tr>
                            <td></td>
                            <td><button type="submit" name=`"updateCatForm:j_idt227" id="updateCatForm:j_idt227" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false"><span class="ui-button-text"> Thêm mới danh mục </span></button>
                                &nbsp;
                            </td>
                        </tr>
