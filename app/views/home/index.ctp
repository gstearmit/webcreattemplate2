...
<?php echo $this->element('creatmenu')?> 
		...
		<div class="row">
			  ...
			  <div class="row">
				<div id="threeBlocks">
					<div id="leftBlock" class="book-content smart-features col-lg-4 col-md-4 col-sm-4 col-xs-12 ez-hotro-box item animate_afc d1 animate_start">
						...
						<div class="content">Alatca is a tool for the fast and easy 	creation of web sites. Simple, on-line and free. You can even use 	your own domain.</div>
						<p class="link">
					...
					<div id="middleBlock" class="book-content click-mouse col-lg-4 col-md-4 col-sm-4 col-xs-12  ez-hotro-box item animate_afc d2 animate_start">
						...
						<div class="content">Hundreds of modern templates tailored to your individual needs. Ideal solutions for personal, business and e-commerce websites.</div>
						<p class="link">
							<a href="<?php echo DOMAIN ?>webcreathtml/free-website-builder/">More information...</a>
						</p>
					</div>
					<div id="rightBlock" class="book-content good-company col-lg-4 col-md-4 col-sm-4 col-xs-12  ez-hotro-box item animate_afc d3 animate_start">
						...
						<div class="content">More than 15,000,000 companies, students,
							artists and bloggers from around the world have already become
							our satisfied users.</div>
						<p class="link">
							<a href="<?php echo DOMAIN ?>webcreathtml/Alatca-reviews/">Who are our
								users?</a>
						</p>
					</div>
					<div class="cleaner">
				...
				<div id="homepageBlock">
					...
					<div id="homepageBlogArea" class="infoBlockArea homepageArea">
						<div id="homepageBlog" class="infoBlock">
							...
							<div id="blogText">
								<p>Enjoy proper display of your website on any mobile device.
									All sites are automatically built for smartphone and tablet
									use.</p>
								<p id="spotLink">
				...
				<div id="firstBlock" class="open">
					<div id="firstWrapper">
						<h2 id="firstHeader">Create a free website with our online website
							builder</h2>
						<div id="firstParagraph">
							...
							<ul>
								...
								<li>Select one of the hundreds of modern templates available</li>
							...
							<p>
								You can create a free website for an unlimited time. You can
								choose from hundreds of modern Alatca templates tailored to
								your individual needs. You can even use your own domain with
								your website. We want you to be happy while using our technology
								and we hope you will enjoy your Alatca website as well as
								15,000,000&nbsp;of our users already do. <strong>Create a free
									website today!</strong>
							</p>
						</div>
					</div>
				</div>
			...
			<div id="headerForms">
				<form id="headerSignUp" name="headerSignUp" action="<?php echo DOMAIN ?>launch-your-site" method="post" enctype="application/x-www-form-urlencoded"><!-- onsubmit="return SignUp.onSubmit(this);" -->
					<fieldset class="withoutSeparator">
						<div id="registrantFullNameWrapper">
							<div class="formRow" id="registrantFullNameRow">
								<label for="registrantFullName" id="registrantFullNameLabel">Website name&nbsp;<b>*</b></label>
								   <span class="inputCase">
								   <input id="registrantFullName" name="storename" type="text" value="" maxlength="32">
									<i>
										<!-- -->
								   </i>
								   </span>
						...
						<div id="signupUserEMailWrapper">
							<div class="formRow" id="signupUserEMailRow">
								...
								<div class="inputHint" id="signupUserEMailHint">
									<h4>Email address</h4>
									<p>Your email address will be used as your login. Don't worry,we don't spam.</p>
									<i>
										<!-- -->
									</i>
								</div>
						...
						<div id="signupUserPwdWrapper">
							<div class="formRow" id="signupUserPwdRow">
								...
								<div class="inputHint" id="signupUserPwdHint">
									<h4>Password</h4>
									<p>The password must have at least six characters. We recommend	a combination of letters and numbers.</p>
									<i>
										<!-- -->
									</i>
								</div>
				...
				<form id="headerSignIn" action="<?php echo DOMAIN ?>webcreathtml/sign-in/" method="post" enctype="application/x-www-form-urlencoded" > <!-- style="display: block; visibility: visible; top: 7px;z-index: 1032;position: absolute;" -->
					...
					<a href="<?php echo DOMAIN ?>webcreathtml/new-password/" id="loginFormNewPwd">Forgot your password?</a><span class="buttonCase"><button type="submit">
							<b>Login</b><i>
								<!-- -->
							</i>
						</button></span>
						...
						<div class="languages">
							<div class="column first">
								<ul>
									...
									<li><a href="<?php echo DOMAIN ?>webcreathtml.ar/"
										><img
									...
									<li><a href="<?php echo DOMAIN ?>webcreathtml.co/"
										><img
									...
									<li><a href="<?php echo DOMAIN ?>webcreathtml.uy/"
										><img
							...
							<div class="column">
								<ul>
									<li><a href="<?php echo DOMAIN ?>webcreathtml.ve/"
										><img
									...
									<li><a href="<?php echo DOMAIN ?>webcreathtml.br/"
										><img
							...
							<div class="column">
								<ul>
									...
									<li><a href="http://www.Alatca.se/" >
										<img src="<?php echo DOMAIN ?>webcreathtml/img/layout3-2/flags/sv.png"
											alt="" width="16" height="11" />Svenska</a></li>
									<li><a href="<?php echo DOMAIN ?>webcreathtml.tr/"> <img src="<?php echo DOMAIN ?>webcreathtml/img/layout3-2/flags/tr.png"
