<div id="layoutsListtow">
	<span class="layoutItem selected" id="layoutItem50000116"><i
		class="lid">
			<!-- -->
	</i><img
		src="http://static-cdn4.webnode.com/_system/_filesystem/_skins/50015010-a9cfaaa4c8-rubicus.jpg"
		height="134" width="149" alt="" border="0"><input id="layout50000116"
		name="layout" type="radio" value="50000116" title="Select template"><label
		for="layout50000116">Select template</label></span><span
		...
		for="layout50000998">Select template</label></span><span
