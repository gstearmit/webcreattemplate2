...
<?php echo $this->element('creatmenu')?> 
		<div id="page" class="container">
			<div id="header" class="initialPage">
				...
				<div id="headerSlogan">
					<h1 id="slogan"><?php __('slogan_Estore')?>!</h1>
					<h4 id="sloganNext"><?php __('slogan_Estores')?></h4>
				</div>
			</div>
			<hr class="hidden">
			<div id="content">
	...
	$contentv = $data['Note']['content_eg'];
		...
		?>
					<div id="<?php echo $id; ?>" class="<?php echo $icon; ?>">
						<h2>
							<a href="<?php echo DOMAIN ?>webcreathtml/features-e-commerce/"><?php echo $titlev; ?></a>
						</h2>
