...
<?php echo $this->element('creatmenu')?> 
		<div id="page" class="container">
			<div id="header" class="initialPage">
				...
				<div id="headerIllustration" class="eCommerce">
					<!-- -->
				</div>
				<div id="headerSlogan">
					<h1 id="slogan">Create an online store!</h1>
					<h4 id="sloganNext">Start selling over the Internet. Quickly and
						easily.</h4>
				</div>
			</div>
			<hr class="hidden">
	...
	$icon="e-commerce-price";
	 ...
	 if($data['Note']['location']==1){
		?>
			...
			<hr class="hidden">
			<div id="headerForms">
				<form id="headerSignUp" action="<?php echo DOMAIN ?>webcreathtml/e-commerce/"
					method="post" onsubmit="return SignUp.onSubmit(this);"
					...
					<fieldset class="withoutSeparator">
						...
						<input type="hidden" name="signup-sent" id="signup-sent" value="1"><input
							...
							type="hidden" name="module_id" id="module_id" value="2">
						<noscript>
							<div id="a0896fa8706Wrapper">
								<div class="formRow" id="a0896fa8706Row">
									<label for="a0896fa8706" id="a0896fa8706Label">Copy the
										following text into the field:<strong>35334a17ea</strong>
									</label><span class="inputCase"><input id="a0896fa8706"
										name="a0896fa8706" type="text" value="" maxlength="255"><i>
											<!-- -->
									</i></span>
								</div>
							</div>
						...
						<span id="headerSignUpButton" class="buttonCase"><button
								type="submit">
								<b>Sign up</b> <span>and launch e-shop</span><i>
									<!-- -->
								</i>
							</button></span>
					</fieldset>
