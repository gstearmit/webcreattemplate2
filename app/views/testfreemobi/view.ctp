...
<div id="sanphamchitiet">
    ...
    <div class="top"><?php echo $views['Estore_products']['title'];?></div>
    ...
    <div class="clearfix">
        <a href="<?php echo DOMAINADESTORE;?><?php echo $views['Estore_products']['images'];?>" class="jqzoom" rel='gal1'  title="triumph" >
            <img src="<?php echo DOMAINADESTORE.'timthumb.php?src='.$views['Estore_products']['images']?>&amp;w=264&amp;zc=1"  title="triumph"  style="border: 4px solid #666;">
        </a>
    </div>
        ...
        <div class="name">
            ...
            <b>Tên sản phẩm:</b>  <?php echo $views['Estore_products']['title'];?><br/>
            <b>Mã sản phẩm: </b>  <?php echo $views['Estore_products']['code'];?><br/>
            <b>Kích thước: </b>  <?php echo $views['Estore_products']['kichthuoc'];?><br/>            
            <b>Giá:</b>  <?php echo number_format( $views['Estore_products']['price'],0); ?> VNĐ<br/></p>
        </div>
            <div class="chitiet"><br />
            <a href="<?php echo DOMAIN?><?php echo $shopname ;?>/addshopingcart/<?php echo $views['Estore_products']['id'];?>"><img src="<?php echo DOMAIN?>home/images/datmua.jpg"/></a>
            </div>
            <!--<b>Giá sản phẩm:</b>  <?php echo number_format( $views['Estore_products']['price'],3); ?> VNĐ<br/></p>
            </div>
            <div class="chitiet"><a href="<?php echo DOMAIN?><?php echo $shopname ;?>/addshopingcart/<?php echo $views['Estore_products']['id'];?>"><img src="<?php echo DOMAIN?>home/images/vietsys_111.jpg"/></a></div><br /><br />
            -->
        </div>
        <div class="clearfix"></div>
        <div class="noidung">
            <?php echo $views['Estore_products']['content'];?>
        </div>
    </div>
    	...
    	<div class="top">Sản phẩm liên quan</div>
         ...
         <div id="dssanpham" align="center">             
            ...
            <div class="name" align="center">
                ...
                <h6>Giá: <?php echo number_format( $pr['Estore_products']['price'],3); ?> VNĐ
...
<?php }?>
 <?php //} 
    ...
    <div id="sanphamchitiet">
    <div class="top">Product <?php echo $views['Estore_products']['title_en'];?></div>
    <div id="dssanpham" style="min-height: 732px !important;">
        <div class="img">
                <img src="<?php echo DOMAINAD.'timthumb.php?src='.$views['Estore_products']['images']?>&amp;h=325&amp;w=330&amp;zc=1" />
        </div>
        <div class="name">
            <span>Details : </span><br /><br />
            <div class="detail" style="line-height: 30px !important;">
            <b>Product Name:</b>  <?php echo $views['Estore_products']['title_en'];?><br/>
            <b>Product Code: </b>  <?php echo $views['Estore_products']['id'];?><br/>
        ...
        <div class="noidung">
            <?php echo $views['Estore_products']['content_en'];?>
        </div>
    </div>
...
<div id="sanphams" >
        ...
        <div id="dssanpham" align="center">
            ...
            <div class="name" align="center">
                ...
                <!--<h6><a href="#tips">Giá: <font color="#FF6600"><?php echo $pr['Estore_products']['price'];?> VNĐ</font></a></h6>
