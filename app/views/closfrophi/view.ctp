                    ...
                    <section class="product-related">
                        <div class="container">
                            <div class="span12">
                                ...
                                <?php 
                                foreach ($sanphamkhac as $sanpham)
                                {
                                ?>
                                
                                    <li class="standard" data-price="160">
                                        <a href="<?php echo DOMAIN;?><?php echo $shopname ;?>/view/<?php echo $sanpham['Estore_products']['id'];?>" title="<?php echo $sanpham['Estore_products']['title'];?>">

                                            <div class="image">
                                                <?php if($sanpham['Estore_products']['images']!=''){?><img class="primary" src="<?php echo DOMAINADESTORE;?><?php echo $sanpham['Estore_products']['images'];?>" alt="<?php echo $sanpham['Estore_products']['title'];?>" /> <?php }?>
                                                <?php if($sanpham['Estore_products']['images1']!=''){?> <img class="secondary" src="<?php echo DOMAINADESTORE;?><?php echo $sanpham['Estore_products']['images1'];?>" alt="<?php echo $sanpham['Estore_products']['title'];?>" /> <?php }?>
                                               <?php if($sanpham['Estore_products']['images']===''){?> <img class="primary" src="<?php echo DOMAIN ?>clothingstore/img/db_file_img_no.jpg"  alt="Alt Text"><?php }?>
        
                                            </div>

                                            <div class="title">
                                                <div class="prices"><span class="price">£<?php echo $sanpham['Estore_products']['price']?></span></div>
                                                <h3><?php echo $sanpham['Estore_products']['title'];?></h3>
