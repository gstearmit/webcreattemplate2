<?php
						 ...
						 class CreativeeshopController extends AppController {
						  var $name = 'Creativeeshop';
						   var $shopname ='creativeeshop';
						  	var $uses = array (
						...
						function requets(){
							...
							$this->layout = 'ajax';
							$this->loadModelNew ( 'Estore_advertisements' );
							if(!isset($_POST['id'])){ return $error = 'error! not found id';}
							...
							$string .='<input type="hidden" name="_method" value="POST" />
					                        ...
					                        <div class="form-group">
					                         ...
					                         <div class="form-group">
					                          <label class="control-label col-sm-3" for="validation_password">Thumbnail Image</label>
					                          <div>
					                        <div class=" input-group col-sm-4 controls" >
					                          <img  src="'. DOMAINADESTORE.$images.'" style="width:197px;height:295px;">
					                        </div>   		
