...
// 			if($slug_lenght>0)
// 			{
// 				//check subname controller
// 				if($slug_lenght<=3)
// 				{
// 					//$subnametmp = @substr($slug, 0,$slug_lenght);
// 					$subname2 = $slug.'freemobi';
// 				}
// 				if(3<$slug_lenght<=5)
// 				{
// 					//$subnametmp = @substr($slug, 0, $slug_lenght);
// 					$subname2 = $slug.'freemo';
// 				}
// 				if(6<$slug_lenght<=10)
// 				{
// 					$subnametmp = @substr($slug, 0, $slug_lenght);
// 					$subname2 = $subnametmp.'free';
// 				}
// 				if(11<$slug_lenght<=15)
// 				{
// 					$subnametmp = @substr($slug, 0, $slug_lenght);
// 					$subname2 = $subnametmp.'fr';
// 				}
// 				if(16<$slug_lenght)
// 				{
// 					$subnametmp = @substr($slug, 0, $slug_lenght);
// 					$subname2 = $subnametmp.'f';
// 				}
// 				$nameController = $subname2;
// 			}else {
// 				$nameController = "nonofreemobi";
// 				die('Subdoamin and namproject being Null!!!');
// 			}
